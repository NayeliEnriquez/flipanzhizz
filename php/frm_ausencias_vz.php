<?php
    ...
    switch ($step) {
        case '1'://***1-> Solicitud
            ...
            if ($total_dias_sol > $total_dias_unico) {//***Candado para revisar que no se repitan los dias solicitados
                echo "NA|NA|NA";
                exit();
            }else{
                foreach ($inp_arrdates as $key => $value) {
                    ...
                    if ($coincidencia > 0) {//***Buscamos que los dias solicitados no se encuentran ya registrados
                        ...
                        if ($inp_f_regreso == $value) {//***Revisamos que el dia de retorno no coincida con los dias solicitados
                            echo "2|NA|NA";
                            exit();
                        }
                    }
            ...
            if ($fecha_now >= $v_hire_one) {//***Revisamos que ya tenga un año o mas para poder solicitar vacaciones
                $v_inline = "true";
                ...
                if(!empty($email_boss)){
                    ...
                    $msn = '
                        <html lang="es">
                            ...
                            <body>
                                <!--<img src="http://187.217.99.180:89/images/novag_logo_small.png" width="160" height="100">-->
                    ...
                    try {
                        ...
                        //$mail->addAddress('ramone.m.28@gmail.com');     // Mail del destinatario
