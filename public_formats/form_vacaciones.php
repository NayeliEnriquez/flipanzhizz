    ...
    <body class="text-center">
        ...
        <div class="container">
            ...
            <div class="col-md-12 col-lg-12">
                <h4 class="mb-3">Formato de vacaciones</h4>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <label for="inp_num_empl_v" class="form-label">Numero de empleado</label>
                        <!--<input class="form-control" list="datalistOptions" id="inp_num_empl_v" placeholder="Busqueda..." onkeyup="busca_empleado_v2(event)">-->
                        <input class="form-control" list="datalistOptions" id="inp_num_empl_v" placeholder="Busqueda..." onkeyup="revisa_pin(this.value, event, 'busca_empleado_v2')">
                    ...
                    <div class="col-md-8 col-sm-12">
                        <br>
                        <div id="respose_srch_dtl_surt_v"></div>
                    </div>
                </div>
                <div id="resp_busca_empleado_v"></div>
            </div>
        </div>
        <!-- Modal -->
        <div class="modal fade" id="mdl_vacaciones" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="mdl_vacacionesLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="mdl_vacacionesLabel">Vacaciones disponibles</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div id="response_vacas"></div>
                    </div>
