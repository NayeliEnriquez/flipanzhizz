...
<html lang="en">
    <head>
        ...
        <title>Novag RH | Registro de horas extra</title>
    ...
    <body class="text-center">
        <?php
            ...
            include('../php/navs/nav_te.php');
        ?>
        <div class="container">
            <br><br><br>
            <div class="col-md-12 col-lg-12">
                <h4 class="mb-3">Registro de horas extra</h4>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        ...
                        <input class="form-control" list="datalistOptions" id="inp_num_empl_te" placeholder="Busqueda..." onkeyup="revisa_pin(this.value, event, 'tiempo_extra')">
                        <datalist id="datalistOptions">
                            <?php
                                $query1 = "SELECT emp_code, first_name, last_name FROM personnel_employee WHERE enable_att = '1' AND department_id IN ('22', '48') ORDER BY emp_code ASC";
                    ...
                    <div class="col-md-8 col-sm-12">
                        <br>
                        <div id="respose_srch_dtl_surt_te"></div>
                    </div>
                </div>
                <div id="resp_busca_empleado_te"></div>
            </div>
        </div>
