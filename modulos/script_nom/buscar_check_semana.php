<?php
    ...
    $exe_name = sqlsrv_query($cnx, $query_name);
    ...
    for ($i=$f_start; $i <= $f_end ; $i+=86400) {
        ...
        */
        ...
        $query_revisa = "SELECT emp_code FROM [zkbiotime].[dbo].[Push_z] WHERE emp_code = '$num_empl' AND fecha LIKE '$f_recorre' ORDER BY fecha DESC";
        ...
        if ($fila_revisa != NULL) {
            if ((strtotime($he_lun)) > (strtotime($hs_lun))) {//***TURNO NOCTURNO
                ...
                $turno = "dia";
                //***OBTENER HORAS LABORALES DENTRO DE LA SEMANA***
                $query_c = "SELECT * FROM [zkbiotime].[dbo].[Push_z] WHERE emp_code = '$num_empl' AND fecha LIKE '$f_recorre' ORDER BY fecha DESC";
                $exe_c = sqlsrv_query($conn, $query_c);
                while ($fila_c = sqlsrv_fetch_array($exe_c, SQLSRV_FETCH_ASSOC)) {
                    $punch_time_c[] = $fila_c['punch_time'];
                    $fecha_c[] = $fila_c['fecha'];
            ...
            case 'Lunes':
                ...
                $div_acordion = "
                    <div class='accordion-item'>
                        <h2 class='accordion-header' id='flush-".$dia_dia."'>
                            <button class='accordion-button' type='button' data-bs-toggle='collapse' data-bs-target='#flush-collapse".$dia_dia."' aria-expanded='true' aria-controls='flush-collapse".$dia_dia."'>
                                ".$dia_dia." ".$f_recorre."
                            </button>
                        </h2>
                        <div id='flush-collapse".$dia_dia."' class='accordion-collapse collapse show' aria-labelledby='flush-".$dia_dia."' data-bs-parent='#accordionFlushExample' style=''>

                            <div class='accordion-body'>";
                            if ($str_permisos != '') {
                                $div_acordion .= "<center><div class='shadow p-3 mb-5 bg-body-tertiary rounded'>Permisos solicitados este dia <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-corner-right-down'><polyline points='10 15 15 20 20 15'></polyline><path d='M4 4h7a4 4 0 0 1 4 4v12'></path></svg><br>".$str_permisos."</div></center>";
                            }
                            $div_acordion .= "
                                <center>
                                    <table>
            ...
            case 'Martes':
                ...
                $div_acordion .= "
                    <div class='accordion-item'>
                        ...
                        <div id='flush-collapse".$dia_dia."' class='accordion-collapse collapse' aria-labelledby='flush-".$dia_dia."' data-bs-parent='#accordionFlushExample' style=''>
...
<div class="row">
    ...
    <div class="col-md-2 col-sm-2">
        <button type="button" class="btn btn-dark" onclick="descarga_pdf_semana(<?php echo($num_empl); ?>, <?php echo($slc_semana); ?>, <?php echo($slc_year); ?>)">Descargar PDF <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-download"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg></button>
    </div>
</div>
<br>
<div class="row">
        ...
        <div style="width:auto; height:auto; overflow:auto;">
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <?php echo($td_tabla); ?>
                        <td class='align-middle'><strong><?php echo($totales_extra); ?> horas</strong></td>
                    </tr>
                </tbody>
                <tfoot>
                    <tr class="table-info">
