<?php
    ...
    */
    ...
    if (!empty($inp_dia_unico)) {
                        ...
                        <center>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><strong>".$he_days." hrs</strong></td>
                                </tr>
                                <tr>
                                    <td>Horario de salida:</td>
                                    <td><strong>".$hs_days." hrs</strong></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan='2'><p style='font-size:18px;'>Total de horas trabajadas: <strong>".$diferencia_norm->format('%H')." Hrs ".$diferencia_norm->format('%i')." Min</strong></p></td>
                                </tr> 
                            </table>
                        </center>
                    </div>
        ...
        //echo "<br>".$slc_quincena." <> ".$slc_year." <> ".$num_empl;
        switch ($slc_quincena) {
            ...
            $div_acordion .= "
                <div class='accordion-item'>
                    <h2 class='accordion-header' id='flush-".$i."'>
                        <button class='accordion-button' type='button' data-bs-toggle='collapse' data-bs-target='#flush-collapse".$i."' aria-expanded='true' aria-controls='flush-collapse".$i."'>
                            ".$dia_dia." ".$v_fecha."
                        </button>
                    </h2>
                    <div id='flush-collapse".$i."' class='accordion-collapse collapse' aria-labelledby='flush-".$i."' data-bs-parent='#accordionFlushExample' style=''>
