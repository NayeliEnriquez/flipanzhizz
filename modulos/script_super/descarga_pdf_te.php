<?php
    ...
    $str_emps_post = $_POST['str_emps'];

    //***ORDENAR POR ORDEN ALFABETICO
    $query_ordenar = "SELECT emp_code FROM [zkbiotime].[dbo].[personnel_employee] WHERE emp_code IN ($str_emps_post) ORDER BY last_name ASC";
